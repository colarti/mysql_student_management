...
class DatabaseConnection:
    def __init__(self, host='localhost', user='root', pw='abendanioM6!87', database='school'):
        self.host = host
        self.user = user
        self.pw = pw
    ...
    def connect(self):
        self.connection = mysql.connect(host=self.host, user=self.user, 
                                        password=self.pw, database=self.database)
